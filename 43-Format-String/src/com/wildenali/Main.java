...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        // Conversion: f = floating point, d = integer, c = character, b = boolean
        ...
        System.out.printf("%1$s, wahai %1$s, kemana saja kamu %1%$?\n", nama);
